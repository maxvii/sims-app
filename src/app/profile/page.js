    ...
    <div className="min-h-screen pb-safe-nav">
      <div className="liquid-glass px-5 pt-12 pb-8 relative overflow-hidden" style={{ borderRadius: '0 0 24px 24px' }}>
        ...
        <div className="flex flex-col items-center relative z-10">
          <div className="w-20 h-20 rounded-full bg-gradient-to-br from-mauve to-pink-400 flex items-center justify-center mb-3 shadow-lg">
      ...
      <div className="px-4 pt-6 space-y-3">
              ...
              {editingName ? (
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="bg-white/50 rounded-lg px-3 py-1.5 text-sm outline-none focus:ring-2 focus:ring-pink-200 border border-white/40 w-36 text-right"
                    autoFocus
                  />
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button onClick={() => setEditingName(true)} className="text-mauve hover:text-pink-500 transition-colors">
        ...
        <div className="liquid-glass-card p-4">
          <div className="flex items-center justify-between mb-3">
            ...
            {!changingPassword && (
              <button onClick={() => setChangingPassword(true)} className="text-xs font-semibold text-mauve hover:text-pink-500 transition-colors">
                Change
              </button>
            )}
          </div>
