    ...
    <div className="space-y-4">
      ...
      <div className="glass-card p-4">
        ...
        <button
          ...
          disabled={uploading}
          className="w-full py-4 border-2 border-dashed border-pink-200 rounded-xl hover:border-pink-400 hover:bg-pink-50/50 transition-all flex flex-col items-center gap-2 disabled:opacity-50"
        >
          {uploading ? (
            <>
              <svg className="w-8 h-8 text-pink-400 animate-spin" viewBox="0 0 24 24"><circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4" fill="none"/><path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z"/></svg>
              <span className="text-sm font-semibold text-pink-500">Uploading...</span>
            </>
          ) : (
            <>
              <svg className="w-8 h-8 text-pink-300" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"/></svg>
            ...
            >
                ...
                <div className="relative aspect-square bg-gray-900 flex items-center justify-center">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center bg-black/20">
                    <div className="w-10 h-10 rounded-full bg-white/80 flex items-center justify-center">
                      <svg className="w-5 h-5 text-pink-500 ml-0.5" fill="currentColor" viewBox="0 0 24 24"><path d="M8 5v14l11-7z"/></svg>
                    </div>
                  </div>
                </div>
              ) : (
              ...
              <div className="p-2.5">
                ...
                <div className="flex items-center justify-between mt-1">
                  ...
                  {m.comments?.length > 0 && (
                    <span className="flex items-center gap-0.5 text-[10px] text-pink-500 font-semibold">
